...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/exercise/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/exercise/store.js");
/* harmony import */ var _utils_wss_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/wss.js */ "./src/utils/wss.js");
...
router.get("/exercise/:id", async ctx => {
  const userId = ctx.state.user._id;
  const exercise = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createExercise = async (ctx, exercise, response) => {
  ...
  try {
    ...
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(exercise);
    response.status = 201; // created

    Object(_utils_wss_js__WEBPACK_IMPORTED_MODULE_2__["broadcast"])(userId, {
      type: "created",
...
router.post("/exercise", async ctx => await createExercise(ctx, ctx.request.body, ctx.response));
...
/***/ "./src/exercise/store.js":
/*!*******************************!*\
  !*** ./src/exercise/store.js ***!
  \*******************************/
/*! exports provided: ExerciseStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExerciseStore", function() { return ExerciseStore; });
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nedb-promise */ "nedb-promise");
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nedb_promise__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = (new ExerciseStore({
...
/* harmony import */ var _exercise__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./exercise */ "./src/exercise/index.js");
...
protectedApiRouter.use("/items", _exercise__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
module.exports = __webpack_require__(/*! D:\Facultate\GitHub\University-Assignments\Fifth Semester\PDM\Lab2\my-node-server-auth-1\src/index.js */"./src/index.js");
